...
| [mailcow](https://github.com/mailcow/mailcow-dockerized) | Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or clouds integrations. | 🔄 |
...
| [KafkaUI](https://github.com/kafbat/kafka-ui) | Web UI for managing Apache Kafka clusters. | 🔄 |
